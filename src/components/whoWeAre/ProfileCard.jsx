    ...
    const tiltEngine = useMemo(() => {
        ...
        const setVarsFromXY = (x, y) => {
            ...
            const properties = {
                ...
                '--rotate-x': `${round(-(centerY / 10))}deg`,
                '--rotate-y': `${round(centerX / 12.5)}deg`
            };
            ...
            <div ref={shellRef} className="pc-card-shell">
                <section className="pc-card">
                    <div className="pc-inside">
                        ...
                        <div className="pc-skills-overlay">
                            <div className="pc-skills-content">
                                {roleTitle && <h4 className="pc-role-title">{roleTitle}</h4>}
